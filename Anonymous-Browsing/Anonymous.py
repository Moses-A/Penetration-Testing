...
class Anonymous(mechanize.Browser):
	def __init__(self, proxies = [], user_agents = []):
		...
		self.user_agents = user_agents + ['Microsoft/8.0 ', 'Internet Explorer/11.01', 'ExactSearch', 'Nokia7110/1.0']	# Sets the variables accessed for in the alter_user_agent function
		self.cookie_jar = cookielib.LWPCookieJar()
		self.set_cookiejar(self.cookie_jar)
		self.anonymize()						# Will self anonymize the computer
