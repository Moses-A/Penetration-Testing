#This code is incomplete and currently is not mine. I copied it directly so that I can alter it for future use. 
# Credit goes to https://gallery.technet.microsoft.com/scriptcenter/PowerShell-Script-Get-beced710

Invoke-Command -ComputerName (Get-Content .ttxt) -scriptblock { 
